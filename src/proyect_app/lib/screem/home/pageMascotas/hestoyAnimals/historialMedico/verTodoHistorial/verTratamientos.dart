...
class verTratamientos extends StatefulWidget {
  ...
  @override
  State<verTratamientos> createState() => _verTratamientosState();
}

class _verTratamientosState extends State<verTratamientos> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
          ...
          toolbarHeight: 70,
          title: Text("Tratamientos", style: GoogleFonts.fredoka(color: Colors.white),),
        ),
        body: Container(
                        ...
                        child: Container(
                          ...
                          decoration: BoxDecoration(
                            ...
                            child: Row(
                              ...
                              children: [
                                Text(
                                  historialMedicoVacuna.tratamientos, 
